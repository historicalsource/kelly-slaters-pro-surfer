...
private:
  ...
  // call delete_instance as soon as possible after you're done with the sound
//  void release_instance( sound_instance * instance );
...
//private:
  ...
  friend class sound_emitter;
  friend class DumpSoundsCommand;
...
public:
  ...
  void release_stream( sound_stream* stream ) {}
...
public:
  ...
  void init(const char* stash_name);
  void shutdown();
  ...
  void release_stream( sound_stream* ) {}
...
private:
	// fixme( "FILENAME_LENGTH changed. -mkv 6/8/01" )
  char listfile_name[64];
  int  listfile_size;
