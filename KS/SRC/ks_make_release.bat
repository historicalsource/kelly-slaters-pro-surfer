...
/NGL/tools/bin/m4 < hwosps2/krvu1.dsm > release/hwosps2/krvu1.pp
...
@make --makefile=ks_makefile release BUILD=release

goto exit

:dual_processor

@make --makefile=ks_makefile -j2 release BUILD=release
